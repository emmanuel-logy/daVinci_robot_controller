...
class connectionTest():
    ...
    def servo_jf(self):
        ...
        self.base.set_joint_effort(3, 0)
        self.base.set_joint_effort(4, 0)
        self.base.set_joint_effort(5, 0)
        self.base.set_joint_pos(6, 0)
        self.base.set_joint_pos(7, 0)
        rospy.sleep(0.01)
...
if __name__ == '__main__':
    ...
    ## For plotting the desired path of the end effector
    ...
    ## For plotting the actual path of the end effector
    fig2 = plt.figure(2)
